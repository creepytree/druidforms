/* <druid-navbar> — the app header: leaf + brand, tabs region, actions region.
   The flavor + accent pickers are built in; a logout button appears when logout-href is set.
...
export class DruidNavbar extends LitElement {
    ...
    static styles = css`
        ...
        /* The tab strip scrolls inside the bar instead of widening the page:
        ...
        /* narrow: keep the brand, tabs and actions on one line by giving up
           the wide gaps and the wordmark rather than by wrapping */
        ...
        return html`
            <header>
                ...
                <div class="actions">
                    ...
                    <druid-flavor-picker></druid-flavor-picker>
